...
const CreateGame = () => {
  ...
  const handleScoreRuleChange = (event) => {
    const { name, value } = event.target;
  ...
  const handleTeamChange = (
    ...
    setFormData((previous) => {
      const updatedTeams = previous.teams.map(
        (team, index) => {
          if (index !== teamIndex) {
            return team;
          }
  ...
  const validateForm = () => {
    ...
    const teamNames = formData.teams.map((team) =>
      ...
      <div className="mx-auto max-w-5xl">
        <header className="mb-8">
          ...
          <p className="mt-2 text-slate-400">
            Configure the game and generate four hidden boards.
          </p>
        </header>
            ...
            <div className="mt-5 grid gap-5 md:grid-cols-2">
              ...
              <div>
                ...
                <input
                  ...
                  min="10"
                  max="3600"
                  value={formData.turnDurationSeconds}
                  onChange={handleBasicChange}
                  disabled={submitting}
                  className="w-full rounded-xl border border-slate-700 bg-slate-950 px-4 py-3 outline-none focus:border-cyan-500"
                />
            ...
            <div className="mt-5 grid gap-5 md:grid-cols-3">
              <div>
                ...
                <input
                  ...
                  type="number"
                  min="0"
                  value={formData.scoreRules.hitPoints}
                  onChange={handleScoreRuleChange}
                  disabled={submitting}
                  className="w-full rounded-xl border border-slate-700 bg-slate-950 px-4 py-3 outline-none focus:border-cyan-500"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  type="number"
                  min="0"
                  value={formData.scoreRules.sunkPoints}
                  onChange={handleScoreRuleChange}
                  disabled={submitting}
                  className="w-full rounded-xl border border-slate-700 bg-slate-950 px-4 py-3 outline-none focus:border-cyan-500"
                />
              ...
              <div>
                ...
                <input
                  ...
                  type="number"
                  min="0"
                  value={formData.scoreRules.finalShipPoints}
                  onChange={handleScoreRuleChange}
                  disabled={submitting}
                  className="w-full rounded-xl border border-slate-700 bg-slate-950 px-4 py-3 outline-none focus:border-cyan-500"
                />
